...
function BottomNav() {
  return (
    <nav
      className="absolute bottom-0 left-0 z-10 flex h-[calc(52px+var(--safe-bottom))] w-full items-start justify-around bg-[var(--surface-2)] px-4 pb-[var(--safe-bottom)] pt-[10px]"
      data-bottom-nav
    >
      <button
        aria-label="Mail"
